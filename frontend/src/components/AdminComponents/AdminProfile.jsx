...
// Form validation schema for admin profile updates
...
// Admin profile management component - allows admin to update their personal information
const AdminProfile = () => {
  ...
  // Handle admin profile update with file upload validation
